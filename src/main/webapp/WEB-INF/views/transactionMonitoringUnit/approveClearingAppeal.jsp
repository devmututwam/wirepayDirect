...
<div class="page-header">
    <div class="page-header-title">
        <h4>Approve Clearing Letter Appeal</h4>
    </div>
    <div class="page-header-breadcrumb">
        <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="#!">Approve Clearing Letter Appeal</a></li>
        </ul>
    </div>
</div>
<div class="page-body">
    <div class="card">
        ...
        <div class="card-header">
            <h5>Approve Certificate Certificate Appeal</h5>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="input-group">
                        ...
                        <textarea disabled readonly rows="10" cols="5" class="form-control" id="reasons" name="reasons" maxlength="2000" required placeholder="Reasons">${clrAppeals.reasons}</textarea>
                    </div>
                    <br>
                </div>
                <div class="col-lg-12">
                    ...
                    <div class="input-group">
                        ...
                        <textarea disabled readonly rows="10" cols="5" minlength="25" maxlength="2000" class="form-control" id="reasons" name="reasons" required placeholder="Reasons">${clrAppeals.reasonsStatus}</textarea>
                    </div>
                    <br>
                </div>
            </div>
            <div class="row"><b class="col-lg-12">Initial Application Details </b>
                ...
                <div class="col-md-12">
                    ...
                    <div class="input-group">
                        ...
                        <textarea disabled readonly rows="6" class="form-control" id="reasonApp" name="reasonApp" maxlength="2000" type="text" required placeholder="Application Reasons">${clrApplications.reasons}</textarea>

                    </div>
                    <br>
                </div>
                <div class="col-md-12">
                    <label for="reasonApp">Current Reasons Of Application's Status </label>
                    <br>
                    <div class="input-group">
                        <span class="input-group-addon">
                            <i class="icofont icofont-comment"></i>
                        </span>
                        <textarea disabled readonly rows="6" class="form-control" id="reasonApp" name="reasonApp" maxlength="2000" type="text" required placeholder="Application Reasons">${clrApplications.reasonsStatus}</textarea>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 text-right">
                    <form id="approved_form" name="approved_form" class="col-md-4" style="display: inline">
                        ...
                        <input class="form-control reference" type="hidden" id="transactionId_1" name="transactionId" required value="${clrAppeals.transactionId}" />
                    ...
                    <form name="send_back_form" id="send_back_form" class="col-md-4" style="display: inline">
                        ...
                        <input class="form-control" type="hidden" id="transactionId_2" name="transactionId" required value="${clrAppeals.transactionId}" />
