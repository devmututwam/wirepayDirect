...
<div class="page-body">
    <div class="card">
        ...
        <div class="card-block">
            <sec:authorize access="hasAnyAuthority('TMU_TPIN_EXCEPT_LIST_REV')">
                <form method="post" id="reviewExceptionalListForm" action=""   >
                            <div style="margin-left: 15px; margin-right: 15px;" class="alert alert-info">
                                Review the initial application for adding a TPIN to the Exception list
                            </div>
                            ...
                            <div class="col-sm-6 col-sm-6" style="float: left;">
                                ...
                                <div class="form-group" id="tpinDiv" style="padding-top:20px;">
                                    ...
                                    <div class="input-group date" id="tpinDivId">
                                        <input type="number"  id="tpinExpt" name="tpinExpt" class="form-control " value="${tmuExceptionalListEntity.tpin}" readonly/>
                                        <br>
                                ...
                                <div class="form-group" style="padding-top:20px;">
                                    ...
                                    <div class="input-group date" >
                                        <input class="form-control" type="text" name="tpinType" id="tpinType" value="${tmuExceptionalListEntity.tpinType}" readonly/>
                                        <br>
                                        <span class="input-group-addon" id="tpinTypeSpan">
                                              <i class="fa fa-calculator"></i>
                                    </span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group" id="processTypeDiv" style="padding-top:20px;">
                                    ...
                                    <div class="input-group date" id="processTypeDivId">
                                        <input type="text"  id="processType" name="processType" class="form-control " value="${tmuExceptionalListEntity.processType}" readonly/>
                                ...
                                <div class="form-group" id="reasonDiv" style="padding-top:20px;">
                                    ...
                                    <div class="input-group date" id="reasonDivId">
                                        <textarea  id="reason" name="reason" rows="4" class="form-control "  readonly>${tmuExceptionalListEntity.reason}</textarea>
                                ...
                                <div class="form-group"  style="padding-top:20px;">
                                    <h4 class="sub-title">Reference Number</h4>
                                    <div class="input-group date" >
                                        <input class="form-control" type="text" name="refNumber" value="${tmuExceptionalListEntity.transactionId}" readonly/>
                                        <br>
                                ...
                                <div class="form-group" id="commentsDiv" style="padding-top:20px;">
                                    ...
                                    <div class="input-group date" id="commentsDivId">
                                        <textarea  id="comments" name="comments" rows="4" class="form-control " placeholder="Enter your comments here." >${tmuExceptionalListEntity.previoudUserComments}</textarea>
                            ...
                            <div class="col-sm-6 col-sm-6" style="float: right;">
                                ...
                                <%--<h4 class="sub-title">Taxpayer Details</h4>--%>

                                <div class="form-group" id="taxpayerNameDiv" style="padding-top:20px;">
                                    <h4 class="sub-title">Taxpayer Name</h4>
                                    <div class="input-group date" id="taxpayerNameDivId">
                                        <input class="form-control" type="text" name="taxpayerNameExcpt" id="taxpayerNameExcpt" placeholder="Name of taxpayer" value="${taxpayer.taxpayerName}" readonly/>
                                        <br>
                                        <span class="input-group-addon" id="nameSpan">
                                              <i class="fa fa-book"></i>
                                    </span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group"  style="padding-top:20px;">
                                    <h4 class="sub-title">Taxpayer Id Number</h4>
                                    <div class="input-group date" >
                                        <input class="form-control" type="text" name="taxpayerIdNumber" value="${taxpayer.idNumber}" readonly/>
                                        <br>
                                        <span class="input-group-addon" >
                                              <i class="fa fa-book"></i>
                                    </span>
                                ...
                                <div class="form-group"  style="padding-top:20px;">
                                    <h4 class="sub-title">Taxpayer Type</h4>
                                    <div class="input-group date" >
                                        <input class="form-control" type="text" name="taxpayerType" value="${taxpayer.taxpayerType}" readonly/>
                                        <br>
                                        <span class="input-group-addon" >
                                              <i class="fa fa-book"></i>
                                    </span>
                                ...
                                <div class="form-group"  style="padding-top:20px;">
                                    <h4 class="sub-title">Taxpayer Phone</h4>
                                    <div class="input-group date" >
                                        <input class="form-control" type="text" name="taxpayerPhone" value="${taxpayer.phoneNumber}" readonly/>
                                        <br>
                                        <span class="input-group-addon" >
                                              <i class="fa fa-book"></i>
                                    </span>
                                ...
                                <div class="form-group"  style="padding-top:20px;">
                                    <h4 class="sub-title">Taxpayer Email</h4>
                                    <div class="input-group date" >
                                        <input class="form-control" type="text" name="taxpayerEmail" value="${taxpayer.email}" readonly/>
                                        <br>
                                        <span class="input-group-addon" >
                                              <i class="fa fa-book"></i>
                                    </span>
                                ...
                                <div class="form-group"  style="padding-top:20px;">
                                    <h4 class="sub-title">Taxpayer Address</h4>
                                    <div class="input-group date" >
                                        <input class="form-control" type="text" name="taxpayerEmail" value="${taxpayer.address}" readonly/>
                                        <br>
                                        <span class="input-group-addon" >
                                              <i class="fa fa-book"></i>
                                    </span>
                                    ...
                                    <div class="form-group" id="tpinLevelDiv" style="padding-top:20px;">
                                        ...
                                        <div class="input-group date" id="tpinLevelDivId">
                                            <input type="text"  id="tpinLevel" name="tpinLevel" class="form-control " value="${tmuExceptionalListEntity.tpinLevel}" readonly/>
                                    ...
                                    <c:if test="${not empty exceptionEpcCodes}">
                                            ...
                                            <div class="form-group" id="epcCodeDivId">
                                                <div class="dt-responsive table-responsive">
                                                    <table id="simpletable" class="table table-hover table-striped table-bordered nowrap" style="width:100%">
                                                        ...
                                                        <tbody>
                                                        <c:forEach var="exceptionEpcCode" items="${exceptionEpcCodes}" varStatus="counter">
                                                            <tr>
                                                                <td>${counter.count}.</td>
                                                                <td>${exceptionEpcCode.name}</td>
                                                                <td>${exceptionEpcCode.code}</td>
                                                            </tr>
                                                        </c:forEach>
                                                        </tbody>
                                                    </table>
                            ...
                            <div class="row col-md-12">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group text-right">
                                        <button class="btn btn-primary btn-sm" type="button" id="approveExcptLi"><i class="fa fa-check"></i> APPROVE</button>
                                        <button class="btn btn-primary btn-sm" type="button" id="sendBackReview"><i class="fa-paper-plane"></i> SENDBACK</button>
                                        <button class="btn btn-primary btn-sm" type="button" id="rejectExcptLi"><i class="icofont icofont-trash"></i> REJECT</button>
                                    </div>
                                </div>
                            </div>
                        </form>
...
<script type="text/javascript" src="<c:url value="/assets/js/transactionMonitoringUnit/reviewExceptionalList.js" />"></script>
<!-- Select 2 js -->
