...
<div class="page-header">
    ...
    <div class="page-header-breadcrumb">
        <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item active"><a href="#!">Configure Account</a></li>
        </ul>
    </div>
</div>
                ...
                <div class="row" id="ARL" style="display:block;">
                    <div class="col-sm-6 col-sm-6" style="float: left;">
                        ...
                        <input class="form-control" type="text"
                               name="accountName" id="accountName" placeholder="name of account" required>
                        <br>
                        <label> Bank Name </label> <br>
                        <input class="form-control" type="text"
                               name="bankName" id="bankName" placeholder="Name of Bank" required>
                        <br>
                        <label> Branch Name </label> <br>
                        <input class="form-control" type="text"
                               name="branchName" id="branchName" placeholder="Name of branch" required>
                        <br>
                    ...
                    <div class="col-sm-6" style="float: right;">
                        ...
                        <input class="form-control" type="text"
                               name="branchCode" id="branchCode" placeholder="branch code" required>
                        <br>
                        <label> Account Number </label> <br>
                        <input class="form-control" type="number"
                               name="accountNumber" id="accountNumber" placeholder="Account Number" maxlength="13" min="0" required>
                        <br>
                        <label> TPIN </label> <br>
                        <input class="form-control" type="number"
                               name="tpin" id="tpin" placeholder="TPIN" maxlength="10" min="0">
                        <br>
                        <br>
