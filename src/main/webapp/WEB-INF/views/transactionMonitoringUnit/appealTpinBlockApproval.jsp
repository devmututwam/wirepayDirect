        ...
        <div class="card-block">
            ...
            <form method="post" id="appealTpinBlockageForm" action=""   >
                <div style="margin-left: 15px; margin-right: 15px;" class="alert alert-info">
                    Review the appeal application and submit your recommendations
                </div>
                ...
                <div class="col-sm-6 col-sm-6" id="columnLeft" style="float: left;">
                    ...
                    <div class="form-group" id="processTypeDiv" style="padding-top:20px;">
                        ...
                        <div class="input-group date" id="processTypeDivId">
                            <select id="processType" name="processType" onchange="getSelectedValue(this)" class="form-control form-control-lg" disabled>
                ...
                <div class="col-sm-6 col-sm-6" style="float: right;">
                    ...
                    <div class="form-group" id="officerReccDiv" style="padding-top:20px;">
                        ...
                        <div class="input-group date" id="officerReccDivId">
                            <textarea  id="officerRecc" name="officerRecc" rows="4" class="form-control " readonly>${tmuAppealTpinBlock.officerRecommendation}</textarea>
                    ...
                    <div class="form-group" id="apvRejReasonDiv" style="padding-top:20px;">
                        <h4 class="sub-title">Approval - Rejection Reason</h4>
                        <div class="input-group date" id="apvRejReasonDivId">
                            <input type="text"  id="apvRejReason" name="apvRejReason" class="form-control " placeholder="Enter your reason for approving or rejecting the appeal" required/>
                            <span class="input-group-addon" id="apvRejReasonSpan">
                                      <i class="fa fa-calculator"></i>
                            </span>
                        </div>
                    </div>
                ...
                <div class="row col-md-12">
                    ...
                    <div class="col-md-6">
                        <div class="form-group text-right">
                            <button class="btn btn-primary btn-sm" type="button" id="approveAppeal"><i class="fa fa-check"></i> APPROVE</button>
                            <button class="btn btn-primary btn-sm" type="button" id="sendBackReview"><i class="fa-paper-plane"></i> SENDBACK</button>
                            <button class="btn btn-primary btn-sm" type="button" id="rejectAppeal"><i class="icofont icofont-trash"></i> REJECT</button>
                        </div>
                    </div>
                </div>
            </form>
...
<script type="text/javascript" src="<c:url value="/assets/js/transactionMonitoringUnit/appealTpinBlockApproval.js" />"></script>
<!-- Select 2 js -->
