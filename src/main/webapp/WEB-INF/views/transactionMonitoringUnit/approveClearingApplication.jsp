...
<div class="page-header">
    <div class="page-header-title">
        <h4>Approve Customs Clearing Letter Application</h4>
    </div>
    <div class="page-header-breadcrumb">
        <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="#!">Approve Customs Clearing Letter Application</a></li>
        </ul>
    </div>
</div>
<div class="page-body">
    <div class="card">
        ...
        <div class="card-header">
            <h5>Approve Customs Clearing Letter Application</h5>
        ...
        <div class="card-block">
            <form disabled readonly id="captureClearingApplicationForm" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input disabled readonly class="form-control" required id="declarant_tpin" type="number" name="declarant_tpin" required placeholder="Your TPIN" value="${clearingApplications.declarantTpin}">
                        </div>
                        <br>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="input-group">
                            ...
                            <textarea disabled readonly rows="10" cols="5" class="form-control" id="reasons" name="reasons" maxlength="2000" required placeholder="Reasons">${clearingApplications.reasons}</textarea>
                        </div>
                        <br>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <label for="reasonsStatus">Reasons For Rejection <red>*</red></label>
                        ...
                        <div class="input-group">
                            ...
                            <textarea rows="8" cols="5" class="form-control" id="reasonsStatus" name="reasonsStatus" maxlength="2000" required placeholder="Reasons For Rejection"></textarea>
                        </div>
                        <br>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12 text-right">
                    <form id="approved_form" name="approved_form" class="col-md-4" style="display: inline">
                        <input type="hidden"  id="approved_input" name="status" value="APPROVED">
                        <input class="form-control" type="hidden" id="transactionId_1" name="applicationRef" required value="${refNumber}"/>
                        ...
                        <button type="submit" id="approve_btn" class="btn btn-success btn-sm" value="Approved">Approve</button>
                    </form>
...
<%--                    </form>--%>
                    <form name="reject_form" id="reject_form" class="col-md-" style="display: inline">
                        ...
                        <input class="form-control" type="hidden" id="transactionId_3" name="applicationRef" required value="${refNumber}"/>
...
<script type="text/javascript" src="<c:url value="/assets/js/transactionMonitoringUnit/approveClearingApplication.js"/>"></script>
