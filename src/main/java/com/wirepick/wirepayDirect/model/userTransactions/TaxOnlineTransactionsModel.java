package com.wirepick.wirepayDirect.model.userTransactions;
...
@Entity
@Table(name = "taxonline_transactions" , schema = "wirepayDirect", catalog = "")
public class TaxOnlineTransactionsModel implements Serializable {
