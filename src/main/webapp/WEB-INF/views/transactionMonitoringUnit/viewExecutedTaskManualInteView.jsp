                            ...
                            <div class="col-sm-6 col-sm-6" style="float: right;">
                                ...
                                <div class="form-group" id="commentsDiv" style="padding-top:20px;">
                                    ...
                                    <div class="input-group date" id="commentsDivId">
                                        <textarea  id="comments" name="comments" rows="4" class="form-control " placeholder="Enter your comments here." readonly>${tmuManualSuspActivation.previoudUserComments}</textarea>
                                ...
                                <div class="form-group" style="padding-top:20px;">
                                    <h4 class="sub-title">REQUEST DELEGATED</h4>
                                    <div class="input-group date">
                                        <input type="text"  id="requDelegated" name="requDelegated" class="form-control " value="${tmuManualSuspActivation.requDelegated}" readonly/>
                                        <span class="input-group-addon">
                                        <i class="fa fa-desktop "></i>
                                    </span>
                                    </div>
                                ...
                                <%--<div class="form-group" style="padding-top:20px;">
                                    <h4 class="sub-title">INITIATED BY</h4>
                                    <div class="input-group date">
                                        <input type="text"  id="inititatedBy" name="inititatedBy" class="form-control " value="${inititatedBy}" readonly/>
                                        <span class="input-group-addon">
                                ...
                                <div class="form-group" style="padding-top:20px;">
                                    <h4 class="sub-title">APPROVED/REJECTED BY</h4>
                                    <div class="input-group date">
                                        <input type="text"  id="approvedBy" name="approvedBy" class="form-control " value="${approvedBy}" readonly/>
                                        <span class="input-group-addon">
                                        <i class="fa fa-user "></i>
                                    </span>
                                    </div>
